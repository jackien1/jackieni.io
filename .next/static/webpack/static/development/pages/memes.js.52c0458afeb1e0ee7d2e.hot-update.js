...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(Memes, [{
    ...
    value: function render() {
      ...
      })(["width:300px;height:387px;border-radius:4px;box-shadow:0 7px 20px 0 rgba(0,0,0,0.12);object-fit:cover;object-position:top;"]);
      var photos = ["https://s3.eu-west-3.amazonaws.com/jackieni.io/memes/1percent.png", "https://s3.eu-west-3.amazonaws.com/jackieni.io/memes/Boat.png", "https://s3.eu-west-3.amazonaws.com/jackieni.io/memes/EstateMeme.png"];
      return __jsx("div", {
        __source: {
        ...
        __self: this
      }, lodash_times__WEBPACK_IMPORTED_MODULE_12___default()(2, Number).map(function (id) {
        return __jsx(Photo, {
          src: photos[id],
          style: {
            marginLeft: "80px"
...
//# sourceMappingURL=memes.js.52c0458afeb1e0ee7d2e.hot-update.js.map